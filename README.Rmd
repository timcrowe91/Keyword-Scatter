...
12. use_package() to add dependencies for "dplyr", "tidyr", "stats", "magrittr" & "ggplot2"
13. use_package("gapminder", type = "Suggests") to use gapminder in vignette etc
14. use_pipe() to allow function to call pipe operator
15. use_vignette() and input brief description of function
